...
const terminalLines = [
  ...
  { text: "  Weighted Avg CPU:      148.2 ms", color: "text-cyan-400", delay: 2.9 },
  { text: "  Weighted Avg Energy:   2.6764 mWh", color: "text-emerald-300", delay: 3.1 },
  { text: "  Weighted Avg CO2:      1.18e-3 gCO2e", color: "text-yellow-300", delay: 3.3 },
